...
export default function AccomProof({ submitAccomProof }: { submitAccomProof: (reportJson: string, requirementsJson: string) => void }) {
  ...
  return (
    <form
      className="main-form"
      onSubmit={(e: any) => {
        submitAccomProof(reportJson, requirementsJson)
